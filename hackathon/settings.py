...
SECRET_KEY = 'django-insecure-5onoza)3o!$zwu^*%i@ms3!q_wrt$$%7t@jmkgfa4g*n@$zaj)'
...
REST_USE_JWT = True
JWT_AUTH_COOKIE = 'jwt-token'           # you can set these
JWT_AUTH_REFRESH_COOKIE = 'jwt-refresh'  # to anything
